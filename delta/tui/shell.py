...
mounted under any App, and inherit theme tokens when a Delta theme is
active.
"""
...
class StatusBar(Horizontal):
    ...
    def __init__(self, delta: Any, active: str = "", context: str = "") -> None:
        super().__init__()
        self.delta = delta
...
class ScreenFooter(Vertical):
    ...
    def __init__(self, delta: Any, *, active: str = "") -> None:
        super().__init__()
        self.delta = delta
        self._active = active

    def compose(self) -> ComposeResult:
        yield StatusBar(self.delta, active=self._active)
...
class DeltaScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        ...
        yield ScreenFooter(self.delta, active=self.name or "")
